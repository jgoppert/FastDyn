...
- Vehicle repositories own their FastDyn board configuration, firmware overlay,
  lockstep adapter, and acceptance tests. FastDyn supplies the reusable runtime
  and configuration contract those integrations consume.
